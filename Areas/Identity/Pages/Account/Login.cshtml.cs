...
namespace WebApplication3.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<WebApplication3User> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var users = from m in _userManager.Users where m.Email.Equals(Input.Email) select m.userrole;
